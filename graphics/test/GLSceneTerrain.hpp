...
#ifndef GLSCENETERRAIN_HPP_
#define GLSCENETERRAIN_HPP_
 ...
 */
class GLSceneTerrain : public GLScene
{
    public:
    ...
    public:
        GLSceneTerrain(int width, int height);
        virtual ~GLSceneTerrain();
    ...
    private:
        ...
        // TERRAIN
        JU::f32*   pheight_data_;
        JU::uint32 height_num_rows_;
        JU::uint32 height_num_cols_;
};

#endif /* GLSCENETERRAIN_HPP_ */
